...
import dev.yacsa.model.mapper.CheckUpdateUiDomainMapperImpl
...
class UiMapperModule {
    ...
    @Provides
    fun providesCheckUpdateUiDomainMapper(): CheckUpdateUiDomainMapper {
        return CheckUpdateUiDomainMapperImpl()
    }
}
